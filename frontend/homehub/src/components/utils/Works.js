      ...
      <div className="w-full ">
        <div className="max-w-[1440px] mx-auto py-4 px-10 flex-col justify-between text-center">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 p-6">
            <div className="hover:border-2 hover:border-[#ccc] border-[1px] border-[#EAEAEA] duration-300  bg-zinc-800  rounded-[50px] rounded-tr-none h-48 overflow-hidden mr-6 text-center">
              <div className=" text-center  pt-6">
                <FaUserCircle className="text-[#fff]	ml-32 mb-4 text-2xl" />
                <h6>Money Matters</h6>
                <p className="text-[12px] text-[#fff]">Decide on your budget and value, you wish to derive</p>
                <p className="text-[12px] ">
                  Check out how to plan on your next vacation{" "}
                  <a className="text-[#74c69d]" href="">
                    Here
                  </a>
                </p>
              </div>
            ...
            <div className="hover:border-2 hover:border-[#ccc] border-[1px] border-[#EAEAEA] duration-300  bg-zinc-800  rounded-[50px] rounded-tr-none h-48 overflow-hidden mr-6 text-center">              {" "}
              <div className=" text-center  pt-6">
                <FaUserCircle className="text-text-[#fff]	ml-32 mb-4 text-2xl" />
                <h6>Make A Deal</h6>
                <p className="text-[12px]">
